      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Link
            ...
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-white bg-black border-2 border-black hover:bg-gray-800 transition-colors duration-200"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-black bg-white border-2 border-black hover:bg-gray-100 transition-colors duration-200"
          >
