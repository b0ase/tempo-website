...
export default function ForArtists() {
  ...
  return (
    <section id="for-artists" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="bg-white border-2 border-black p-6 text-center hover:bg-gray-50 transition-colors duration-200"
            >
        ...
        <div className="bg-black text-white p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start">
              <svg className="w-6 h-6 text-white mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
              </svg>
              <div>
                <h4 className="text-white font-semibold mb-1">Publishing Tools</h4>
                <p className="text-gray-300 text-sm">Upload songs with artwork, metadata, and custom pricing</p>
              </div>
            </div>
            <div className="flex items-start">
              <svg className="w-6 h-6 text-white mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Track plays, earnings, and fan engagement in real-time</p>
              </div>
            </div>
            <div className="flex items-start">
              <svg className="w-6 h-6 text-white mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Blockchain-based copyright protection and licensing</p>
              </div>
            </div>
            <div className="flex items-start">
              <svg className="w-6 h-6 text-white mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Direct connection with listeners through the platform</p>
              </div>
            </div>
          </div>
        </div>
